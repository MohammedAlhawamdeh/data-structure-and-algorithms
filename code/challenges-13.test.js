...
const firstLetters = (arr) => {
  // Solution code here...
  arr.reduce( (accumulator, currentValue) => accumulator.concat([currentValue.charAt(0)]), []);
};
...
const findHappiness = (arr) => {
    arr.reduce( (accumulator, currentValue) => currentValue.includes(':)') ? accumulator.concat([currentValue]) : accumulator, []);
  // Solution code here...
};
...
const onlyOddChars = (str) => {
  // Solution code here...
  str.split('').reduce((accumulator, currentValue, index) => index % 2 !== 0 ? accumulator + currentValue : accumulator, '');
};
...
const allHappy = (arr) => {
  // Solution code here...
  arr.every((currentValue) => currentValue.includes(':)'));
};
...
const findAnything = (arr, target) => {
    arr.reduce( (accumulator, currentValue) => currentValue.includes(target) ? accumulator.concat([currentValue]) : accumulator, []);
  // Solution code here...
};
